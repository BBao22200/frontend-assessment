...
Before running this project, make sure you have Node.js 18 installed on your machine.
...
If you need to install or update Node.js, visit [https://nodejs.org/](https://nodejs.org/) or use a version manager like [nvm](https://github.com/nvm-sh/nvm):
